...
Все LLM-утилиты (mistral, geminillm, ghllm, groqllm, plnllm, cerebrasllm) были обновлены для поддержки унифицированного набора флагов командной строки.
...
# Пример с cerebrasllm
cerebrasllm.exe -s "Ты ассистент" -t 0.7 -m vision
```
